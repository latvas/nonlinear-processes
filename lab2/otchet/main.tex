...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{../../graphs/u_First_order_approximation_right_up.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{../../graphs/p_First_order_approximation_right_up.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{../../graphs/u_Second_order_approximation_friedr_closest.png}
    \caption{График для $u$ \\ }
    \label{fig:vac}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{../../graphs/p_Second_order_approximation_friedr_closest.png}
    \caption{График для $p$ \\ }
    \label{fig:vac}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{../../graphs/u_Third_order_approximation.png}
    \caption{График для $u$ \\ }
    \label{fig:vac}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{../../graphs/p_Third_order_approximation.png}
    \caption{График для $p$ \\ }
    \label{fig:vac}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{../../graphs/u_Third_order_approximationSecond_order_approximation_friedr_closestFirst_order_approximation_right_up.png}
    \caption{График для $u$ \\ }
    \label{fig:vac}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{../../graphs/p_Third_order_approximationSecond_order_approximation_friedr_closestFirst_order_approximation_right_up.png}
    \caption{График для $p$ \\ }
    \label{fig:vac}
\end{figure}
