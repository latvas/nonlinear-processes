...
\begin{figure}[h!]
    \centering
    \includegraphics[width=15cm]{../graphs/Second_order_approximation_1Second_order_approximation_2First_order_approximation_right_up.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=15cm]{../graphs/Third_order_approximationSecond_order_approximation_1First_order_approximation_right_up.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=15cm]{../graphs/Third_order_approximationSecond_order_approximation_2First_order_approximation_right_up.png}
    \caption{Гибридная схема из \ref{subsec:6p}\\ }
    \label{fig:vac}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=15cm]{../graphs/Third_order_approximationSecond_order_approximation_1Second_order_approximation_2First_order_approximation_right_up.png}
